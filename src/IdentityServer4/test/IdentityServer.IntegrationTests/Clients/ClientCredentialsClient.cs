...
namespace IdentityServer.IntegrationTests.Clients
{
    public class ClientCredentialsClient
    {
        ...
        public async Task Valid_request_single_audience_should_return_expected_payload()
        {
            ...
            payload.EnumerateObject().Count().Should().Be(8);
            payload.TryGetString("iss").Should().Be("https://idsvr4");
            payload.TryGetString("client_id").Should().Be("client");
            payload.TryGetString("jti").Should().NotBeNull();
            payload.TryGetString("iat").Should().NotBeNull();

            payload.TryGetString("aud").Should().Be("api");

            var scopes = payload.TryGetValue("scope").EnumerateArray().Select(x => x.ToString());
        ...
        public async Task Valid_request_multiple_audiences_should_return_expected_payload()
        {
            ...
            var audiences = payload.TryGetValue("aud").EnumerateArray().Select(x => x.ToString());
        ...
        public async Task Valid_request_with_confirmation_should_return_expected_payload()
        {
            ...
            payload.EnumerateObject().Count().Should().Be(9);
            payload.TryGetString("iss").Should().Be("https://idsvr4");
            payload.TryGetString("client_id").Should().Be("client.cnf");
            payload.TryGetString("jti").Should().NotBeNull();
            payload.TryGetString("iat").Should().NotBeNull();
            ...
            //todo: investigate
            //payload.TryGetValue("cnf").TryGetString("x5t#S256").Should().Be("foo");
        }
        ...
        public async Task Request_For_client_with_no_secret_and_basic_authentication_should_succeed()
        {
            ...
            payload.TryGetString("iss").Should().Be("https://idsvr4");
            payload.TryGetString("client_id").Should().Be("client.no_secret");
        ...
        private JsonElement GetPayload(TokenResponse response)
        {
            ...
            var dictionary = JsonSerializer.Deserialize<JsonElement>(
